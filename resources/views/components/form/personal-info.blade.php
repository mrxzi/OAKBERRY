<div class="flex basis-full flex-col rounded-lg border border-gray-200 bg-white px-5 py-5 shadow dark:border-gray-700 dark:bg-gray-800">
	...
	<p>Harap isi ID KARYAWAN pribadi Anda dengan lengkap. dan pilih setuju Setelah selesai, silakan lanjutkan dengan menekan tombol "Selanjutnya."</p>
</div>
<div class="flex basis-full flex-col space-y-5 rounded-lg border border-gray-200 bg-white px-5 py-5 shadow dark:border-gray-700 dark:bg-gray-800">
	...
	<form action="{{ route('kuesioner') }}" method="GET">
		...
		<div class="mb-5">
			<label for="name" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">ID KARYAWAN</label>
		...
		<div class="mb-5">
			<label for="age" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">CODE</label>
		...
		<div class="mb-5">
			<label for="educations" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">PILIH</label>
		...
		<div class="mb-5">
			<label for="jobs" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">PILIH</label>
		...
		<div class="mb-5">
			<label for="villages" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">PILIH</label>
